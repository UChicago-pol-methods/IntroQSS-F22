...
A&M endorse Angrist's pragmatic view (footnote 7). Bayesian alternative. 
...
**Note**: $V[\overline{X}] = V[X]/n$ is true for any sample size. CLT applies asymptotically (i.e. large $n$).
...
Note that $\text{E}[\epsilon_i] = \text{E}[X_i] - E[E[X]] = E[X_i] - E[X] = 0$.
